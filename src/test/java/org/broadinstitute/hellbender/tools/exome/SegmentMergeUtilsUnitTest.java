...
public final class SegmentMergeUtilsUnitTest extends BaseTest {
    ...
    public static final class SmallSegmentsTestHelper {
        ...
        private static Genome makeGenome(final List<List<ReadCountRecord.SingletonRecord>> targetCoverages,
                                         final List<List<AllelicCount>> snpCounts) {
            final List<ReadCountRecord.SingletonRecord> records = new ArrayList<>();
        ...
        public Object[][] dataSmallSegmentMerging() {
            return new Object[][]{
                    //=================================================================================================
                    {
                            ...
                            Arrays.asList(
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target1", new SimpleInterval("chr2", 100, 109)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target2", new SimpleInterval("chr2", 110, 119)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target3", new SimpleInterval("chr2", 120, 250)), 1.0)
                                    ),
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target4", new SimpleInterval("chr2", 300, 400)), 1.0)
                                    ),
                                    Arrays.asList(
                                            //no targets
                                    )
                    ...
                    //=================================================================================================
                    {
                            ...
                            Arrays.asList(
                                    ...
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target1", new SimpleInterval("chr2", 300, 400)), 1.0)
                                    ),
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target2", new SimpleInterval("chr2", 450, 509)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target3", new SimpleInterval("chr2", 510, 519)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target4", new SimpleInterval("chr2", 520, 600)), 1.0)
                                    )
                            ),
                            //SNP counts
                            Arrays.asList(
                    ...
                    //=================================================================================================
                    {
                            ...
                            Arrays.asList(
                                    ...
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target5", new SimpleInterval("chr2", 500, 509)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target6", new SimpleInterval("chr2", 510, 519)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target7", new SimpleInterval("chr2", 520, 600)), 1.0)
                                    )
                            ),
                            //SNP counts
                            Arrays.asList(
                    ...
                    //=================================================================================================
                    {
                            ...
                            Arrays.asList(
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target1", new SimpleInterval("chr2", 100, 109)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target2", new SimpleInterval("chr2", 110, 119)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target3", new SimpleInterval("chr2", 120, 200)), 1.0)
                                    ),
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target4", new SimpleInterval("chr2", 300, 400)), 1.0)
                                    ),
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target5", new SimpleInterval("chr2", 450, 509)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target6", new SimpleInterval("chr2", 510, 519)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target7", new SimpleInterval("chr2", 520, 600)), 1.0)
                                    )
                            ),
                    ...
                    //=================================================================================================
                    {
                            ...
                            Arrays.asList(
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target1", new SimpleInterval("chr1", 100, 109)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target2", new SimpleInterval("chr1", 110, 119)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target3", new SimpleInterval("chr1", 120, 200)), 1.0)
                                    ),
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target4", new SimpleInterval("chr2", 300, 400)), 1.0)
                                    ),
                    ...
                    //=================================================================================================
                    {
                            ...
                            Arrays.asList(
                                    ...
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target5", new SimpleInterval("chr3", 500, 509)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target6", new SimpleInterval("chr3", 510, 519)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target7", new SimpleInterval("chr3", 520, 600)), 1.0)
                                    )
                            ),
                            //SNP counts
                            Arrays.asList(
                    ...
                    //=================================================================================================
                    {
                            ...
                            Arrays.asList(
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target1", new SimpleInterval("chr2", 100, 109)), 2.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target2", new SimpleInterval("chr2", 110, 119)), 2.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target3", new SimpleInterval("chr2", 120, 200)), 2.0)
                                    ),
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target4", new SimpleInterval("chr2", 300, 400)), 1.0)
                                    ),
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target5", new SimpleInterval("chr2", 500, 509)), 3.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target6", new SimpleInterval("chr2", 510, 519)), 3.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target7", new SimpleInterval("chr2", 520, 600)), 3.0)
                                    )
                            ),
                            //SNP counts
                    ...
                    //=================================================================================================
                    {
                            ...
                            Arrays.asList(
                                    ...
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target4", new SimpleInterval("chr2", 300, 400)), 3.0)
                                    ),
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target5", new SimpleInterval("chr2", 500, 509)), 2.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target6", new SimpleInterval("chr2", 510, 519)), 2.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target7", new SimpleInterval("chr2", 520, 600)), 2.0)
                                    )
                            ),
                            //SNP counts
                            Arrays.asList(
                    ...
                    //=================================================================================================
                    {
                            ...
                            Arrays.asList(
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target1", new SimpleInterval("chr2", 100, 109)), 0.7),
                                            new ReadCountRecord.SingletonRecord(new Target("target2", new SimpleInterval("chr2", 110, 119)), 0.8),
                                            new ReadCountRecord.SingletonRecord(new Target("target3", new SimpleInterval("chr2", 120, 129)), 0.9),
                                            new ReadCountRecord.SingletonRecord(new Target("target4", new SimpleInterval("chr2", 130, 139)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target5", new SimpleInterval("chr2", 140, 200)), 1.1)
                                    ),
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target6", new SimpleInterval("chr2", 310, 319)), 0.95),
                                            new ReadCountRecord.SingletonRecord(new Target("target7", new SimpleInterval("chr2", 320, 329)), 1.05)
                                    ),
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target8", new SimpleInterval("chr2", 500, 509)), 0.85),
                                            new ReadCountRecord.SingletonRecord(new Target("target9", new SimpleInterval("chr2", 510, 519)), 0.95),
                                            new ReadCountRecord.SingletonRecord(new Target("target10", new SimpleInterval("chr2", 520, 529)), 1.05),
                                            new ReadCountRecord.SingletonRecord(new Target("target11", new SimpleInterval("chr2", 530, 539)), 1.15),
                                            new ReadCountRecord.SingletonRecord(new Target("target12", new SimpleInterval("chr2", 540, 600)), 1.25)
                                    )
                            ),
                            //SNP counts
                            Arrays.asList(
                    ...
                    //=================================================================================================
                    {
                            ...
                            Arrays.asList(
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target1", new SimpleInterval("chr2", 100, 109)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target2", new SimpleInterval("chr2", 110, 119)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target3", new SimpleInterval("chr2", 120, 299)), 1.0)
                                    ),
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target4", new SimpleInterval("chr2", 300, 400)), 1.0)
                                    ),
                                    Arrays.asList(
                                            new ReadCountRecord.SingletonRecord(new Target("target5", new SimpleInterval("chr2", 401, 409)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target6", new SimpleInterval("chr2", 410, 419)), 1.0),
                                            new ReadCountRecord.SingletonRecord(new Target("target7", new SimpleInterval("chr2", 420, 600)), 1.0)
                                    )
                            ),
                            //SNP counts
                            Arrays.asList(
        ...
        public void testSmallSegmentMerging(final String caseDescription,
                                            ...
                                            final List<List<ReadCountRecord.SingletonRecord>> targetCoverages,
                                            final List<List<AllelicCount>> snpCounts,
                                            final List<SimpleInterval> expectedMergedSegments) {
