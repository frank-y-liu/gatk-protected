...
public class SegmentUtilsUnitTest extends BaseTest {
    ...
    public void testSegmentDifference() {
        final ReadCountRecord.SingletonRecord target1 =
                new ReadCountRecord.SingletonRecord(new Target("myTarget", new SimpleInterval("chr1", 1, 2)), 1.0);
        final ReadCountRecord.SingletonRecord target2 =
                new ReadCountRecord.SingletonRecord(new Target("myTarget", new SimpleInterval("chr1", 3, 4)), 2.0);
        final ReadCountRecord.SingletonRecord target3 =
                new ReadCountRecord.SingletonRecord(new Target("myTarget", new SimpleInterval("chr2", 3, 4)), 5.0);
        final ReadCountRecord.SingletonRecord target4 =
                new ReadCountRecord.SingletonRecord(new Target("myTarget", new SimpleInterval("chr2", 5, 6)), 6.0);
        final HashedListTargetCollection<ReadCountRecord.SingletonRecord> targets =
