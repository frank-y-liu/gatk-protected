...
public final class SegmentMergeUtils {
    ...
    private static final class SmallSegments {
        ...
        private static List<Double> makeCoverageList(final SimpleInterval segment,
                                                     final TargetCollection<ReadCountRecord.SingletonRecord> targets) {
            return targets.targets(segment).stream().map(ReadCountRecord.SingletonRecord::getCount).collect(Collectors.toList());
        }
        ...
        private static Pair<Double, Double> calculateScores(final List<SimpleInterval> segments,
            ...
            final TargetCollection<ReadCountRecord.SingletonRecord> targets = genome.getTargets();
