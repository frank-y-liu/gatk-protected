...
public final class ACNVModeledSegmentConversionUtils {
    ...
    @VisibleForTesting
    static ModeledSegment convertACNVModeledSegmentToModeledSegment(ACNVModeledSegment acnvModeledSegment, TargetCollection<ReadCountRecord.SingletonRecord> targets) {
