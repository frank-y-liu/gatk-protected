...
public final class CoverageDropoutDetector {
    ...
    private MixtureMultivariateNormalFitResult retrieveGaussianMixtureModelForFilteredTargets(final ModeledSegment segment,
        final TargetCollection<ReadCountRecord.SingletonRecord> targets, final double minProportion, final int numComponents){
    ...
    private MixtureMultivariateNormalFitResult retrieveGaussianMixtureModelForFilteredTargets(final List<ModeledSegment> segments,
        final TargetCollection<ReadCountRecord.SingletonRecord> targets, double minProportion, int numComponents){
    ...
    private List<Double> getNumProbeFilteredTargetList(final List<ModeledSegment> segments,
        final TargetCollection<ReadCountRecord.SingletonRecord> targets, final double minProportion) {
     ...
     */
    public CoverageDropoutResult determineCoverageDropoutDetected(final List<ModeledSegment> segments, final TargetCollection<ReadCountRecord.SingletonRecord> targets,
