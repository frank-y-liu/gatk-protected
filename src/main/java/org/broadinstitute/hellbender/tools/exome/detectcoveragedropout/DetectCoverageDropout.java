...
public final class DetectCoverageDropout extends CommandLineProgram {
    ...
    protected Object doWork(){
        ...
        final TargetCollection<ReadCountRecord.SingletonRecord> targetList = new HashedListTargetCollection<>(
                counts.records().stream().map(ReadCountRecord::asSingleton).collect(Collectors.toList()));
